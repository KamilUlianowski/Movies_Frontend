...
var movie_1 = require("../details/movie");
var MovieTrailersComponent = (function () {
    function MovieTrailersComponent() {
    }
...
], MovieTrailersComponent.prototype, "movie", void 0);
MovieTrailersComponent = __decorate([
    core_1.Component({
        selector: 'movie-trailers',
        templateUrl: 'app/movies/trailers/movie-trailer.component.html'
    })
